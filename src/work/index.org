...
APIs for external users where we had to consider API versioning, compabilitiy
and communication to these external users about breakage. We also managed
huge data imports of product data to make available in the API.

...
:PROPERTIES:
:CUSTOM_ID: looking-up-how-bad-it-was
:END:
...
:PROPERTIES:
:CUSTOM_ID: setting-up-a-work-environment
:END:
...
:PROPERTIES:
:CUSTOM_ID: takeaways-from-today
:END:
...
as early as I did and I'm not sure that I would have been able to save any
of the data.

...
#+TITLE: NixOS ❄: tmpfs as root (UEFI edition)
#+DATE: <2020-05-02 Sat 10:00>
#+OPTIONS: toc:t

If you're on MBR or Legacy boot, I'd recommend to read my follow-up post
targeting specifically this kind of setups:
[[../../../2021/03/nixos-tmpfs-as-root-legacy-boot-edition/][NixOS ❄: tmpfs as root (legacy boot edition)]].
...
it's located here: [[file:../../06/nixos-tmpfs-as-home/][NixOS ❄: tmpfs as home]].

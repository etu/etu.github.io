...
[[https://github.com/nix-community/home-manager/][Home Manager]] to manage the home directory. It's an excellent way to configure
...
To make this even better, [[https://github.com/talyz][talyz]] spent quite some time to implement modules to
help doing persistence handling better -- both in NixOS, but also as a Home
Manager module. These modules became the [[https://github.com/nix-community/impermanence][impermanence]] community project.

...
#+DATE: <2023-11-05 Sat 22:30>

* My history with coffee
:PROPERTIES:
:CUSTOM_ID: my-history-with-coffee
:END:
...
:PROPERTIES:
:CUSTOM_ID: where-am-i-at-with-tea-though
:END:
...
:PROPERTIES:
:CUSTOM_ID: my-three-classifications-of-tea
:END:
...
:END:
 ...
 - Most teas that doesn't have a name other than a color such as "black" or
   "green"
 - Tea that smells more like perfume but tastes like nothing like hot water
...
:PROPERTIES:
:CUSTOM_ID: the-cultural-dominance-of-coffee
:END:
...
:PROPERTIES:
:CUSTOM_ID: so-can-i-get-used-to-coffee
:END:
...
:PROPERTIES:
:CUSTOM_ID: so-do-i-like-coffee-now
:END:

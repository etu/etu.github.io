...
algorithms:
  - name: Sexy Move
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R U R' U'"
  ...
  - name: CFOP / OLL Cross / Line
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=F R U R' U' F'"
  ...
  - name: CFOP / OLL Cross / Dot
    ...
    description:
      ...
      correctly oriented.
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=F R U R' U' F' f R U R' U' f'"
  ...
  - name: CFOP / OLL Corners / Sune
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R U R' U R U2 R'"
  ...
  - name: CFOP / OLL Corners / Anti-Sune
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R U2 R' U' R U' R'"
  ...
  - name: CFOP / OLL Corners / Headlights
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R U R' U R U2 R' U R U2 R' U' R U' R'"
  ...
  - name: CFOP / OLL Corners / Bowtie
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R U R' U R U2 R' U2 R U2 R' U' R U' R'"
  ...
  - name: CFOP / OLL Corners / Double Sune
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R U R' U R U2 R' R U R' U R U2 R'"
  ...
  - name: CFOP / OLL Corners / Pi
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R U R' U R U2 R' U' R U R' U R U2 R'"
  ...
  - name: CFOP / PLL Corners / T-Perm (Headlights)
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R U R' U' R' F R2 U' R' U' R U R' F'"
  ...
  - name: CFOP / PLL Corners / Y-Perm (No Headlights)
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=F R U' R' U' R U R' F' R U R' U' R' F R F'"
  ...
  - name: CFOP / PLL Edges / Ua-perm (Counter clockwise)
    ...
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R2 U' R' U' R U R U R U' R"
  ...
  - name: CFOP / PLL Edges / Ub-perm (Clockwise)
    ...
    description:
      ...
      in the last layer in a counter-clockwise direction while keeping the
      other pieces in place.
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=R' U R' U' R' U' R' U R U R2"
  ...
  - name: CFOP / PLL Edges / H-perm
    ...
    description:
      ...
      pieces in place.
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=M2 U' (M2 U2 M2) U' M2"
  ...
  - name: CFOP / PLL Edges / Z-perm
    ...
    description:
      ...
      pieces in place.
    params: "buttonbar=1&speed=10&initmove=x2&initrevmove=#&move=M' U' M2 U' M2 U' M' U2 M2 U"
---
